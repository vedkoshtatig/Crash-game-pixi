...
export class GameController {
  ...
  private activeRoundId: number = 0
  ...
  // ⭐ ignore old round packets
  if (roundId <= this.activeRoundId) return
  ...
  if (this.store.phase === "FLYING") return
  if (this.store.phase === "CRASHED") return
