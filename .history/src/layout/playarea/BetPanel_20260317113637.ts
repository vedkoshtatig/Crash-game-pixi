...
const betTab = card.querySelector(".bc-tab-bet")!
const autoTab = card.querySelector(".bc-tab-auto")!
const pill = card.querySelector(".bc-switch-pill")!

betTab.addEventListener("click", () => {
