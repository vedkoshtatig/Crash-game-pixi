...
this.bg = new Sprite(Texture.from("https://pixijs.io/examples/examples/assets/bunny.png"));
...
export class FlyArea extends Container {
  ...
  init() {
    ...
    // background
  this.bg = Sprite.from("https://pixijs.io/examples/examples/assets/bunny.png");
this.addChild(this.bg);
