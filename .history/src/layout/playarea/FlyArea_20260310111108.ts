...
startCameraTransition() {
  ...
  if (this.isWaiting) return; // ⭐ prevent looping
  ...
  this.isWaiting = false; // ⭐ allow next waiting phase
...
flyPlane(time: number, multiplier: number) {
  ...
  gsap.killTweensOf(this.plane); // stop any running animations
