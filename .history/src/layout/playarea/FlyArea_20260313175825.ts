...
this.jet.state.setAnimation(0, "Rest", true);
...
this.jet.scale.set(0.1)
    ...
    if (!this.isFlying && !this.isCrashed) {
      this.jet.position.set(this.startX, this.startY+40);
    }
  }
  ...
  resetPlane() {
    ...
    const startLeft = -120;
    this.jet.position.set(startLeft, this.startY+40);
