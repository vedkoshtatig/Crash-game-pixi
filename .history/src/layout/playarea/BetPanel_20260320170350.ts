import { Graphics, Container, Ticker, isMobile } from "pixi.js";
...
if (isMobile) {
  this.wrapper.style.justifyContent = "center";   // ⭐ centre cards vertically
  this.wrapper.style.alignItems = "center";       // ⭐ centre horizontally feel better
}
else {
  this.wrapper.style.justifyContent = "flex-start"; // ⭐ desktop behaviour
  this.wrapper.style.alignItems = "stretch";
}
this.wrapper.style.gap = isMobile ? "16px" : "10px";                       // spacing now auto handled
  this.wrapper.style.padding = "12px";
  this.wrapper.style.boxSizing = "border-box";
  this.wrapper.style.overflowY = isMobile ? "hidden" : "auto";
};
