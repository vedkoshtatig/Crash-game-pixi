...
private currentMultiplier = 1;
  ...
  constructor() {
    ...
    app.ticker.add(this.updateFlight, this);
  }
...
updateFlight(delta: number) {

  if (!this.isFlying) return;

  // smooth interpolation
  this.currentTime += (this.targetTime - this.currentTime) * 0.1;
  this.currentMultiplier += (this.targetMultiplier - this.currentMultiplier) * 0.1;

  this.flyPlane(this.currentTime, this.currentMultiplier);
  ...
  this.targetMultiplier = data.multiplier;
