...
private panelHeight = 0;
  ...
  public addBetCard() {
   ...
   card.innerHTML = `
<div class="w-full h-full bg-[#111] rounded-2xl p-3 flex flex-col">

   <div class="flex flex-1 gap-3">

      <button class="bc-bet-btn flex-1 rounded-2xl bg-green-500 hover:bg-green-400 active:scale-95 transition
      flex flex-col items-center justify-center text-white font-bold text-xl">
         <span class="bc-bet-title">Bet</span>
         <span class="bc-bet-amt text-sm opacity-80">1.00 USD</span>
      </button>

      <div class="w-[110px] flex flex-col justify-center gap-3">

         <div class="flex items-center justify-between bg-[#1c1c1c] rounded-xl px-2 py-1">
            <div class="bc-minus cursor-pointer text-lg">−</div>
            <div class="bc-amount font-semibold">1.00</div>
            <div class="bc-plus cursor-pointer text-lg">+</div>
         </div>

         <div class="grid grid-cols-2 gap-2">
            <div class="bc-q bg-[#1c1c1c] rounded-lg text-center py-1 cursor-pointer" data-val="1">1</div>
            <div class="bc-q bg-[#1c1c1c] rounded-lg text-center py-1 cursor-pointer" data-val="2">2</div>
            <div class="bc-q bg-[#1c1c1c] rounded-lg text-center py-1 cursor-pointer" data-val="5">5</div>
            <div class="bc-q bg-[#1c1c1c] rounded-lg text-center py-1 cursor-pointer" data-val="10">10</div>
         </div>
   ...
   <div class="mt-3 flex items-center justify-between bg-[#1a1a1a] rounded-xl px-3 py-2">
      <span class="text-sm opacity-80">Auto Cashout</span>
      <div class="bc-switch-pill w-12 h-6 bg-[#333] rounded-full relative cursor-pointer">
         <div class="bc-switch-highlight absolute top-0 left-0 w-6 h-6 bg-green-400 rounded-full transition-all"></div>
      </div>
   </div>
