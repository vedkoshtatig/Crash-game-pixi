...
private panelHeight = 0;
  ...
  if (!s.autoBetEnabled) {
    s.setAutoBet(true);   // enable auto mode
  } else {

    // if bet already placed this round
    if (s.hasBet) {
      s.cancelBet();
