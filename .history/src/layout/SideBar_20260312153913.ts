...
export class SideBar extends Container {
  ...
  private roundTitleText!: Text;
  private rountTitle : Container
  ...
  init() {
    ...
    this.roundTitle= new Container
    this.roundTitleText = new Text({
      text: "Round Result",
      style: {
        fill: "#8b97a6",
        fontSize: 18
