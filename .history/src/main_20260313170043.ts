import { spineLoader } from "@esotericsoftware/spine-pixi-v8";
...
import "./style.css";
 ...
 await Assets.load(["/bg.png","/plane-idle.png" , "/plane-run.png" ,"/plane-blast.png" , "/Clouds_01.png",alias: "jetSpine",
